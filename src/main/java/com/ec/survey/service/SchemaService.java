...
public class SchemaService extends BasicService {
	...
	public void step118() {
		...
		String existing = settingsService.get(Setting.NightlyTaskStart);
		if (existing == null) {
			Setting s = new Setting();
	...
	public void step94() {
		...
		NativeQuery query = session.createNativeQuery("UPDATE LANGUAGES SET LANGUAGE_OFFI = 1 WHERE LANGUAGE_CODE = 'HR'");
		query.executeUpdate();
	...
	public void step91() {
		...
		NativeQuery query = session.createNativeQuery("ALTER TABLE SETTINGS MODIFY SETTINGS_VALUE TEXT");
		query.executeUpdate();
	...
	public void step77() {
		...
		NativeQuery query = session.createNativeQuery("UPDATE SURVEYS SET SURVEYSKIN = 1 WHERE SURVEYSKIN is null");
		query.executeUpdate();
	...
	public void step71() {
		...
		query = session.createNativeQuery(checkIndexExists2);
		if (query.list().isEmpty()) {
			logger.info(
					"SchemaService Step71 Execute SQL CREATE INDEX IDX_TRANSLATIONS_SURVEY_ID on TRANSLATIONS (SURVEY_ID)");
			session.createNativeQuery(createkIndex2).executeUpdate();
		} else {
		...
		query = session.createNativeQuery(checkIndexExists3);
		if (query.list().isEmpty()) {
			logger.info("SchemaService Step71 Execute SQL CREATE INDEX IDX_SURVEYS_SURVEY_UID on SURVEYS (SURVEY_UID)");
			session.createNativeQuery(createkIndex3).executeUpdate();
		} else {
	...
	public void step67() {
		...
		NativeQuery query = session
				.createNativeQuery("UPDATE MESSAGE_TYPES SET MT_CSS = 'message-success' WHERE MT_CSS = 'alert-success';");
		query.executeUpdate();

		query = session.createNativeQuery("UPDATE MESSAGE_TYPES SET MT_CSS = 'message-info' WHERE MT_CSS = 'alert-info';");
		query.executeUpdate();

		query = session
				.createNativeQuery("UPDATE MESSAGE_TYPES SET MT_CSS = 'message-error' WHERE MT_CSS = 'alert-danger';");
		query.executeUpdate();
	...
	public void step51() {
		...
		NativeQuery query = session.createNativeQuery("UPDATE ATTENDEE SET OWNER_ID = 0 WHERE OWNER_ID IS NULL");
		query.executeUpdate();
	...
	public void step45() {
		...
		NativeQuery deleteQuery = session
				.createNativeQuery("UPDATE ANSWERS_SET SET UNIQUECODE = UUID() WHERE length(UNIQUECODE) > 36");
		deleteQuery.executeUpdate();

		NativeQuery query = session.createNativeQuery("ALTER TABLE ANSWERS_SET MODIFY UNIQUECODE VARCHAR(36)");
		query.executeUpdate();

		query = session.createNativeQuery("ALTER TABLE SURVEYS MODIFY TITLE TEXT");
		query.executeUpdate();

		query = session.createNativeQuery("ALTER TABLE SURVEYS MODIFY CONFIRMATION TEXT");
		query.executeUpdate();

		query = session.createNativeQuery("ALTER TABLE SURVEYS MODIFY ESCAPE TEXT");
		query.executeUpdate();
		...
		query = session.createNativeQuery("ALTER TABLE PARTICIPANTS MODIFY TEMPL2 TEXT");
		query.executeUpdate();

		query = session.createNativeQuery("ALTER TABLE ELEMENTS MODIFY ETITLE TEXT");
		query.executeUpdate();

		query = session.createNativeQuery("ALTER TABLE ELEMENTS MODIFY QHELP TEXT");
		query.executeUpdate();

		query = session.createNativeQuery("ALTER TABLE TRANSLATION MODIFY LABEL TEXT");
		query.executeUpdate();
	...
	public void step38() {
		...
		try {
			NativeQuery queryCreateIndex = session.createNativeQuery("ALTER TABLE ELEMENTS_FILES DROP INDEX files_FILE_ID;");
	...
	public void step33() {
		...
		NativeQuery query = session.createNativeQuery("ALTER TABLE ATTRIBUTE MODIFY ATTRIBUTE_VALUE LONGTEXT");
		query.executeUpdate();

		// create indexes
		NativeQuery queryCreateIndex = session
				.createNativeQuery("CREATE INDEX INX_DEP_ORG ON ECASUSERS(USER_DEPARTMENT ASC, USER_ORGANISATION ASC)");
		queryCreateIndex.executeUpdate();
	...
	public void step26() {
		...
		NativeQuery query = session.createNativeQuery("UPDATE ELEMENTS SET MINNUMBER = null WHERE MINNUMBER = 0;");
		query.executeUpdate();

		query = session.createNativeQuery("UPDATE ELEMENTS SET MAXNUMBER = null WHERE MAXNUMBER = 0;");
		query.executeUpdate();
	...
	public void step17() {
		...
		NativeQuery query = session.createNativeQuery("UPDATE ELEMENTS SET SOURCE_ID = ID WHERE SOURCE_ID IS NULL");
		query.executeUpdate();

		query = session.createNativeQuery("UPDATE ELEMENTS SET ELEM_UID = SOURCE_ID");
		query.executeUpdate();
	...
	public void step15() {
		...
		NativeQuery query = session
				.createNativeQuery("UPDATE INVITATIONS SET INV_DEACTIVATED = 0 WHERE INV_DEACTIVATED IS NULL");
		query.executeUpdate();
	...
	public void step8() {
		...
		NativeQuery query = session.createNativeQuery("ALTER TABLE PARTICIPANTS MODIFY TEMPL1 LONGTEXT");
		query.executeUpdate();

		query = session.createNativeQuery("ALTER TABLE PARTICIPANTS MODIFY TEMPL2 LONGTEXT");
		query.executeUpdate();
	...
	public void step7() {
		...
		NativeQuery query = session.createNativeQuery("UPDATE EXPORTS SET EXPORT_VALID = 0 WHERE EXPORT_VALID IS NULL");
		query.executeUpdate();
	...
	public void step6() {
		...
		NativeQuery query = session.createNativeQuery("ALTER TABLE ELEMENTS MODIFY QHELP LONGTEXT");
		query.executeUpdate();
	...
	public void step5() {
		...
		NativeQuery query = session.createNativeQuery("UPDATE SURVEYS SET DBVERSION = 0 WHERE DBVERSION IS NULL");
		query.executeUpdate();
	...
	public void step4() {
		...
		NativeQuery query = session.createNativeQuery("ALTER TABLE ANSWERS MODIFY VALUE LONGTEXT");
		query.executeUpdate();

		query = session.createNativeQuery("ALTER TABLE SURACCESS MODIFY ACCESS_DEPARTMENT VARCHAR(255)");
		query.executeUpdate();
	...
	public void step2() {
		...
		NativeQuery query = session.createNativeQuery("ALTER TABLE SURVEYS MODIFY SURVEY_START_DATE DATETIME");
		query.executeUpdate();

		query = session.createNativeQuery("ALTER TABLE SURVEYS MODIFY SURVEY_END_DATE DATETIME");
		query.executeUpdate();

		query = session.createNativeQuery("ALTER TABLE TRANSLATION MODIFY LABEL LONGTEXT");
		query.executeUpdate();
	...
	public void step1() {
		...
		NativeQuery query = session.createNativeQuery("UPDATE SURVEYS SET NOTIFYALL = false WHERE NOTIFYALL IS NULL");
		query.executeUpdate();

		query = session.createNativeQuery("UPDATE SURVEYS SET NOTIFIED = false WHERE NOTIFIED IS NULL");
		query.executeUpdate();

		query = session.createNativeQuery("UPDATE SURVEYS SET ACTIVE = true WHERE ACTIVE IS NULL");
		query.executeUpdate();

		query = session.createNativeQuery("UPDATE ELEMENTS SET QATT = true WHERE QATT IS NULL");
		query.executeUpdate();

		query = session.createNativeQuery("UPDATE ELEMENTS SET QOPTIONAL = true WHERE QOPTIONAL IS NULL");
		query.executeUpdate();
	...
	public void copyEcasData() {
		...
		Session session = sessionFactory.getCurrentSession();
		// copy data
		NativeQuery queryEcasData = session.createNativeQuery(
	...
	public void deleteDuplicateRows(String tableName, String idColumnName, String... valueColumns) {
		...
		NativeQuery selectQuery = session.createNativeQuery(sqlQueryString);

		List<?> duplicateRows = selectQuery.list();

		NativeQuery deleteQuery = session.createNativeQuery(sqlDeleteString);

		if (!duplicateRows.isEmpty()) {
			for (Object row : duplicateRows) {
				Object[] a = (Object[]) row;
				for (int i = 0; i < length; i++) {
					deleteQuery.setParameter(valueColumns[i], a[i].toString());
				}
				deleteQuery.setParameter(idColumnName, (Integer) a[length]);
				deleteQuery.executeUpdate();
			}
		}
	}
	...
	public void createUniqueConstraint(String tableName, String constraintName, String... columns) {
		...
		try {
			...
			Session session = sessionFactory.getCurrentSession();
			NativeQuery query = session.createNativeQuery(sqlQueryString);
			query.executeUpdate();
		} catch (SQLGrammarException e) {
			// Hibernate 4
			logger.error(e);
