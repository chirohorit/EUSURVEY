...
<div class="formmenu" id="divActionsFromMenu">
	...
	<c:if test="${sessioninfo.owner == USER.id || USER.formPrivilege > 1 || USER.getLocalPrivilegeValue('AccessResults') > 0 || USER.getLocalPrivilegeValue('AccessDraft') > 0 || USER.getResultAccess() != null}">
	...
	<c:choose>
		...
		<c:when test="${sessioninfo.owner == USER.id || USER.formPrivilege > 1 || USER.getLocalPrivilegeValue('FormManagement') > 0}">
