...
<body>
	...
	<div class="fullpage">					
		<div style="margin-left: auto; margin-right: auto; width: 850px">
			<h1><spring:message code="label.ImportLanguages" /></h1>
				
			<div style="margin-top: 50px;">
				<form:form action="${contextpath}/administration/languages?${_csrf.parameterName}=${_csrf.token}" modelAttribute="uploadItem" name="frm" id="import-languages-form" method="post" enctype="multipart/form-data" style="margin: 0px;">
